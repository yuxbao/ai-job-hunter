...
class JobPosting(BaseModel):
    ...
    tech_tags: list[str] = Field(default_factory=list, description="技能/工具标签")
    ...
    experience_level: str = Field(default="", description="经验要求 (校招/实习/应届/不限/社招)")
    ...
    def to_csv_dict(self) -> dict:
        return {
            ...
            "salary": self.salary,
            "skill_tags": ", ".join(self.tech_tags),
